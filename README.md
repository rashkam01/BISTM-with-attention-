...
This project aims at recognizing company and domain specific named-entity and relations between the entities extracted from huge text data. 
The model forms a bases at building domain ontologies or company specific knowledge graphs. 
...
However, each and every product already has an fmea(Failure mode and effect analysis document), an fmea pre-defines risk analysis, 
