...
The project uses an attention-based BiLSTM, to extract semantic relations between the selected entities in the test dataset. The attention BiLSTM model achieves an f1-score of 0.66 on the relation extraction task. Total accuracy achieved on training dataset is 94% and test dataset is 61%. The high domain-specific data caused certain limitations to the results.
